...
LABEL Name="senzing/go-cmdhelping-builder" \
...
ENV REFRESHED_AT=2023-02-22
LABEL Name="senzing/go-cmdhelping" \
      Maintainer="support@senzing.com" \
      Version="0.0.5"

# Copy files from prior step.

COPY --from=go_builder "/output/linux/go-cmdhelping" "/app/go-cmdhelping"
